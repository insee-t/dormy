          ...
          <ListboxItem
            ...
            startContent={
              isCompact ? null : item.icon ? (
                <Icon
                  className={cn(
                    "text-#4F5665 group-data-[selected=true]:text-foreground ",
                    iconClassName,
                  )}
                  icon={item.icon}
                  width={24}
    ...
    return (
      <Listbox
        ...
        itemClasses={{
          ...itemClasses,
          base: cn(
            "px-3 min-h-11 rounded-large h-[44px] data-[selected=true]:bg-default-100 mb-1",
            itemClasses?.base,
          ),
          title: cn(
            "text-small font-medium /* text-default-500 */ text-#4F5665 group-data-[selected=true]:text-foreground",
            itemClasses?.title,
          ),
        }}
        items={items}
